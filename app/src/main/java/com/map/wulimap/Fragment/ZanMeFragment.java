...
public class ZanMeFragment extends Fragment {
    static ZanMeFragment fragment;
    ...
    public static ZanMeFragment newInstance(Context context) {
        fragment = new ZanMeFragment();
        context1 = context;
        return fragment;
    }

    public ZanMeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_zanme, container, false);
                ...
                case 1:
                    ...
                    baseAdapter = new BaseAdapter() {
                        ...
                        public View getView(int i, View view, ViewGroup viewGroup) {
                            int j = zongshu - 1 - i;
                            SharedPreferences sharedPreferences = context1.getSharedPreferences("zanwo", Context.MODE_PRIVATE);
                            LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(context1)
                                    .inflate(R.layout.zan_me, null);
