...
public class Friend_rijiActivity extends AppCompatActivity implements OnDismissCallback {
    //初始化控件
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_friend_riji);
    ...
    public void initview() {
        ...
        rippleView1.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                Friend_rijiActivity.this.finish();
            }
...
//沉浸模式
    ...
    private class LongTimeOperationTask1 extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (!(zongshu == 0)) {
                ...
                ToastUtil.show(Friend_rijiActivity.this, "已加载");
            } else {
                ToastUtil.show(Friend_rijiActivity.this, "TA还没有日记!");
            }
    ...
    private class LongTimeOperationTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            swipeRefreshLayout.setRefreshing(false);
            if (!(zongshu == 0)) {
                ToastUtil.show(Friend_rijiActivity.this, "已刷新");
            }
        }
    }
                ...
                case 1:
                    ...
                    baseAdapter = new BaseAdapter() {
                        ...
                        public View getView(int i, View view, ViewGroup viewGroup) {
                            SharedPreferences sharedPreferences = getSharedPreferences("tarenriji", MODE_PRIVATE);
                            LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(Friend_rijiActivity.this)
                            ...
                            if (FileUtil.wenjianshifoucunzai("/sdcard/map/" + tupianming + "-yasuo.jpg")) {
                                ...
                                new LoadAndSaveImage(Friend_rijiActivity.this, imageview, tupianming + "-yasuo.jpg", "http://wode123123-test.stor.sinaapp.com/" + bianmatupianming + "-yasuo.jpg", "/sdcard/map/");
                                /*
...
//下面出现动画
                    SwingBottomInAnimationAdapter swingBottomInAnimationAdapter = new SwingBottomInAnimationAdapter(new SwipeDismissAdapter(baseAdapter, Friend_rijiActivity.this));
...
//右边出现动画
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            SharedPreferences sharedPreferences5 = getSharedPreferences("tarenriji", MODE_PRIVATE);
                            ...
                            bundle.putString("gongxiang", sharedPreferences5.getString("gongxiang" + index, null));
                            ...
                            Intent intent = new Intent(Friend_rijiActivity.this, RijiDetailActivity.class);
                    ...
                    break;
                case 2:
                    ToastUtil.show(Friend_rijiActivity.this, "获取数据失败！检查网络");
    ...
    public void huoqushuju() {
        new Thread() {
            public void run() {
                try {
                    wangzhi = HtmlService.getHtml("http://wode123123.sinaapp.com/gushiditu/huoqurijinicheng.php?nicheng=" + tarennicheng1);
                } catch (Exception e) {
