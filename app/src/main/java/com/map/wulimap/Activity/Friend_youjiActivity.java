                    ...
                    baseAdapter = new BaseAdapter() {
                        ...
                        public View getView(int i, View view, ViewGroup viewGroup) {
                            ...
                            if (FileUtil.wenjianshifoucunzai("/sdcard/map/" + tupianming + "-yasuo.jpg")) {
                                ...
                                new LoadAndSaveImage(Friend_youjiActivity.this, imageview, tupianming + "-yasuo.jpg", Constant.PICTURE_URI + bianmatupianming + "-yasuo.jpg@294w_165h_1l", "/sdcard/map/");
...
//下面出现动画
    ...
    public void huoqushuju() {
        new Thread() {
            public void run() {
                try {
                    wangzhi = HtmlService.getHtml(Constant.PHP_URL + "gushiditu/huoquyoujinicheng.php?nicheng=" + tarennicheng1);
