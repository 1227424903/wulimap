...
public class My_youjiActivity extends AppCompatActivity implements OnDismissCallback {
    //初始化控件
...
//添加游记按钮
        ...
        rippleView.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            @Override
            public void onComplete(RippleView rippleView) {
                My_youjiActivity.this.startActivity(new Intent(My_youjiActivity.this, Write_youjiActivity.class));
            }
...
//透明状态栏
    ...
    private class LongTimeOperationTask1 extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (!(zongshu == 0)) {
                ...
                ToastUtil.show(My_youjiActivity.this, "已加载");
            } else {
                ToastUtil.show(My_youjiActivity.this, "还没有游记！去写吧");
            }
    ...
    private class LongTimeOperationTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            swipeRefreshLayout.setRefreshing(false);
            if (!(zongshu == 0)) {
                ToastUtil.show(My_youjiActivity.this, "已刷新");
            }
        }
    }
                ...
                case 1:
                    ...
                    baseAdapter = new BaseAdapter() {
                        ...
                        public View getView(int i, View view, ViewGroup viewGroup) {
                            ...
                            LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(My_youjiActivity.this)
...
//下面出现动画
                    SwingBottomInAnimationAdapter swingBottomInAnimationAdapter = new SwingBottomInAnimationAdapter(new SwipeDismissAdapter(baseAdapter, My_youjiActivity.this));
...
//右边出现动画
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            Intent intent = new Intent(My_youjiActivity.this, MyYoujiDetailActivity.class);
                    ...
                    break;
                case 2:
                    ToastUtil.show(My_youjiActivity.this, "获取数据失败！检查网络");

                    break;
                case 3:
                    ToastUtil.show(My_youjiActivity.this, "还没有游记！请写吧");
