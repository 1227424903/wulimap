...
public class YoujiDetailActivity extends AppCompatActivity {
    //初始化变量
    String youjiid;
    String shoujihao;
    String nicheng;
...
//返回按钮
        ...
        rippleView1.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                ...
                YoujiDetailActivity.this.setResult(0, intent);
            ...
            public void onComplete(RippleView rippleView) {
                new Thread() {
                    ...
                    public void run() {
                        super.run();
                        try {
                            getjieguo = HtmlService.getHtml(Constant.PHP_URL + "gushiditu/zanyouji.php?youjiid=" + youjiid + "&shoujihao=" + shoujihao1 + "&nicheng=" + nicheng2 + "&shoujihao1=" + shoujihao + "&nicheng1=" + nicheng3 + "&shanchu=0");
                            //删首尾空
...
//个人详情  踩踩
        TextView textView22 = (TextView) findViewById(R.id.cai);
        if (nicheng.equals("小木")) {
                        ...
                        public void run() {
                            ...
                            if (!(getjieguo == null || getjieguo == "")) {
                                ...
                                if (getjieguo.equals("0")) {
                                    ...
                                    YoujiDetailActivity.this.startActivity(new Intent(YoujiDetailActivity.this, FriendAcountActivity.class));
                                }
                            } else {
                            }
                        }
...
//图片处理
        ...
        if (FileUtil.wenjianshifoucunzai("/sdcard/map/" + tupian + "-yasuo.jpg")) {
            ...
            new LoadAndSaveImage(YoujiDetailActivity.this, imageView, tupian + "-yasuo.jpg", Constant.PICTURE_URI + tupianbianmaming + "-yasuo.jpg@294w_165h_1l", "/sdcard/map/");
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // 点击放大
            public void onClick(View paramView) {
              ...
              /*
                ...
                final AlertDialog dialog = new AlertDialog.Builder(YoujiDetailActivity.this).create();
...
//地图按钮
        ...
        go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(YoujiDetailActivity.this, GoMapActivity.class);
        ...
        fabiaopinglun.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!pinglunneirong.equals("")) {
                    ...
                    new Thread() {
                        public void run() {
                            try {
                                ...
                                HtmlService.getHtml(Constant.PHP_URL + "gushiditu/pinglunyouji.php?youjiid=" + youjiid + "&shoujihao=" + shoujihao1 + "&nicheng=" + nicheng2 + "&shoujihao1=" + shoujihao + "&nicheng1=" + nicheng3 + "&neirong=" + pinglunneirong1 + "&shanchu=0");
                            } catch (Exception e) {
                            }
                    ...
                    ToastUtil.show(YoujiDetailActivity.this, "不能为空！");
                }
            }
        });
...
//分享按钮
        ...
        imageButton11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sheet = new BottomSheet.Builder(YoujiDetailActivity.this).icon(GetRoundedBitmapUtil.getRoundedBitmap(R.drawable.app_icon_white_big, YoujiDetailActivity.this)).title("分享到:").sheet(R.menu.list_five_share).listener(new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case R.id.QQ:
                                ...
                                mTencent.shareToQQ(YoujiDetailActivity.this, params, myListener);
                                break;
                            case R.id.QQZONE:
                                ...
                                mTencent.shareToQQ(YoujiDetailActivity.this, params1, myListener);
                                break;
                            ...
                            case R.id.yulan:
                                ...
                                Intent intent = new Intent(YoujiDetailActivity.this, WebActivity.class);
                                intent.putExtras(bundle);
                                startActivity(intent);
                                break;
                        }
...
//获取传入数据
        Intent intent = getIntent();
        youjiid = intent.getStringExtra("youjiid");
...
//评论
                if (Integer.parseInt(pinglunshu) == 0) {
                    ...
                    if (!(getjieguo == null || getjieguo == "")) {
                        ...
                        try {
                            JSONArray arr = new JSONArray(getjieguo);
                            SharedPreferences sharedPreferences1 = getSharedPreferences("tuijianyoujipinglun", MODE_PRIVATE);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    //显示评论
                    SharedPreferences sharedPreferences2 = getSharedPreferences("tuijianyoujipinglun", MODE_PRIVATE);
                    for (int i = 0; i < Integer.parseInt(pinglunshu); i++) {
                        LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(YoujiDetailActivity.this)
                ...
                case 2:
                    //网络异常
                    ToastUtil.show(YoujiDetailActivity.this, "获取数据失败！检查网络");

                    break;
                case 3:
                    //评论 成功
                    ToastUtil.show(YoujiDetailActivity.this, "评论成功!");
                    LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(YoujiDetailActivity.this)
                            .inflate(R.layout.comment_white, null);
                    TextView textView = (TextView) linearLayout.findViewById(R.id.pinglunnicheng);
                ...
                case 4:
                    ...
                    zan1.setText(zanshu);
                    shou.setImageResource(R.drawable.button_zan_done);
                    ToastUtil.show(YoujiDetailActivity.this, "赞成功！");
                    break;
                case 5:
                    //取消赞
                    ...
                    zanshu = Integer.toString(Integer.parseInt(zanshu) - 1);
                    zan1.setText(zanshu);
                    ToastUtil.show(YoujiDetailActivity.this, "取消赞成功！");
                    shou.setImageResource(R.drawable.button_zan);
                    break;
            }
        }
