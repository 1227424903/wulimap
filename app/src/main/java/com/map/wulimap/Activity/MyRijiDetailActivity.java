...
//图片详情按钮
        imageView.setOnClickListener(new View.OnClickListener() { // 点击放大
            public void onClick(View paramView) {
                ...
                MyRijiDetailActivity.this.startActivity(intent);
...
//分享按钮
        ...
        myListener = new QQShareListener(MyRijiDetailActivity.this);
...
//评论
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        QQShareListener myListener = new QQShareListener(MyRijiDetailActivity.this);
