...
public class MyRijiDetailActivity extends AppCompatActivity {
    //初始化变量
    String gongkai;
    String rijiid;
    String shoujihao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_riji_detail);
...
//返回按钮
        ...
        rippleView1.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                ...
                MyRijiDetailActivity.this.setResult(0, intent);
                MyRijiDetailActivity.this.finish();
            }
...
//图片详情按钮
        imageView.setOnClickListener(new View.OnClickListener() { // 点击放大
            public void onClick(View paramView) {
                View imgEntryView = (View) LayoutInflater.from(MyRijiDetailActivity.this)
                        .inflate(R.layout.pop_photo_dialog, null);

                final AlertDialog dialog = new AlertDialog.Builder(MyRijiDetailActivity.this).create();
...
//删除按钮
        ...
        rippleView.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                ...
                //对话框选择
                new AlertDialog.Builder(MyRijiDetailActivity.this)
                        .setTitle("是否确定删除")
...
//地图按钮
        ...
        go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MyRijiDetailActivity.this, GoMapActivity.class);
...
//分享按钮
        ...
        myListener = new ShareListener(MyRijiDetailActivity.this);
        ImageButton imageButton11 = (ImageButton) findViewById(R.id.fenxiang);
        imageButton11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                sheet = new BottomSheet.Builder(MyRijiDetailActivity.this).icon(GetRoundedBitmapUtil.getRoundedBitmap(R.drawable.app_icon_white_big, MyRijiDetailActivity.this)).title("分享到:").sheet(R.menu.list_five_share).listener(new DialogInterface.OnClickListener() {
                    @Override
...
//获取传入数据
        ...
        rijiid = sharedPreferences.getString("rijiid" + index, null);
        ...
        gongkai = sharedPreferences.getString("gongxiang" + index, null);
...
//评论
                if (Integer.parseInt(pinglunshu) == 0) {
                    ...
                    if (!(getjieguo == null || getjieguo == "")) {
                        ...
                        try {
                            JSONArray arr = new JSONArray(getjieguo);
                            SharedPreferences sharedPreferences1 = getSharedPreferences("woderijipinglun", MODE_PRIVATE);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    //显示赞数据
                    zan.setText(zanderen);
                    SharedPreferences sharedPreferences2 = getSharedPreferences("woderijipinglun", MODE_PRIVATE);
                    for (int i = 0; i < Integer.parseInt(pinglunshu); i++) {
                        LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(MyRijiDetailActivity.this)
                ...
                case 2:
                    //网络异常
                    ToastUtil.show(MyRijiDetailActivity.this, "获取数据失败！检查网络");
                ...
                case 3:
                    ...
                    editor.putString("rijishu", Integer.toString(Integer.parseInt(sharedPreferences.getString("rijishu", null)) - 1));
                    editor.commit();
                    ToastUtil.show(MyRijiDetailActivity.this, "删除成功");
                    Intent intent = getIntent();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ShareListener myListener = new ShareListener(MyRijiDetailActivity.this);
