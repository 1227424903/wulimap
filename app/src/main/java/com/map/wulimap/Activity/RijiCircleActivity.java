...
public class RijiCircleActivity extends AppCompatActivity implements OnDismissCallback {
    //初始化控件
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_riji_circle);
...
//返回按钮
        ...
        rippleView1.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                RijiCircleActivity.this.finish();
            }
...
//card
        ...
        rippleView.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                ...
                bundle.putString("id", "weiguanzhuriji");
                bundle.putString("zongshu", Integer.toString(zongshu));
                Intent intent = new Intent(RijiCircleActivity.this, CardActivity.class);
...
//沉浸模式
    ...
    private class LongTimeOperationTask1 extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (!(zongshu == 0)) {
                ...
                ToastUtil.show(RijiCircleActivity.this, "已加载");
            } else {
                ToastUtil.show(RijiCircleActivity.this, "还没有关注日记!");
            }
    ...
    private class LongTimeOperationTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            swipeRefreshLayout.setRefreshing(false);
            if (!(zongshu == 0)) {
                ToastUtil.show(RijiCircleActivity.this, "已刷新");
            }
        }
    }
                ...
                case 1:
                    ...
                    baseAdapter = new BaseAdapter() {
                        ...
                        public View getView(int i, View view, ViewGroup viewGroup) {
                            int j = i;
                            SharedPreferences sharedPreferences = getSharedPreferences("weiguanzhuriji", MODE_PRIVATE);
                            LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(RijiCircleActivity.this)
...
//下面出现动画
                    SwingBottomInAnimationAdapter swingBottomInAnimationAdapter = new SwingBottomInAnimationAdapter(new SwipeDismissAdapter(baseAdapter, RijiCircleActivity.this));
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            SharedPreferences sharedPreferences5 = getSharedPreferences("weiguanzhuriji", MODE_PRIVATE);
                            ...
                            Intent intent = new Intent(RijiCircleActivity.this, RijiDetailActivity.class);
                            intent.putExtras(bundle);
                    ...
                    break;
                case 2:
                    ToastUtil.show(RijiCircleActivity.this, "获取数据失败！检查网络");
