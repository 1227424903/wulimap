...
public class YoujiCircleActivity extends AppCompatActivity implements OnDismissCallback

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_youji_circle);
...
//返回按钮
        ...
        rippleView1.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                YoujiCircleActivity.this.finish();
            }
...
//card
        final RippleView rippleView = (RippleView) findViewById(R.id.kapian);
        rippleView.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {

            @Override
            public void onComplete(RippleView rippleView) {
                Bundle bundle = new Bundle();
                bundle.putString("id", "weiguanzhuyouji");
                bundle.putString("zongshu", Integer.toString(zongshu));
                Intent intent = new Intent(YoujiCircleActivity.this, CardActivity.class);
...
//沉浸模式
    ...
    private class LongTimeOperationTask1 extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (!(zongshu == 0)) {
                ...
                ToastUtil.show(YoujiCircleActivity.this, "已加载");
            } else {
                ToastUtil.show(YoujiCircleActivity.this, "还没有关注游记!");
            }
    ...
    private class LongTimeOperationTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            swipeRefreshLayout.setRefreshing(false);
            if (!(zongshu == 0)) {
                ToastUtil.show(YoujiCircleActivity.this, "已刷新");
            }
        }
    }
                ...
                case 1:
                    ...
                    baseAdapter = new BaseAdapter() {
                        ...
                        public View getView(int i, View view, ViewGroup viewGroup) {
                            SharedPreferences sharedPreferences = getSharedPreferences("weiguanzhuyouji", MODE_PRIVATE);
                            LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(YoujiCircleActivity.this)
                            ...
                            if (FileUtil.wenjianshifoucunzai("/sdcard/map/" + tupianming + "-yasuo.jpg")) {
                                ...
                                new LoadAndSaveImage(YoujiCircleActivity.this, imageview, tupianming + "-yasuo.jpg", Constant.PICTURE_URI + bianmatupianming + "-yasuo.jpg@294w_165h_1l", "/sdcard/map/");
...
//下面出现动画
                    SwingBottomInAnimationAdapter swingBottomInAnimationAdapter = new SwingBottomInAnimationAdapter(new SwipeDismissAdapter(baseAdapter, YoujiCircleActivity.this));
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            SharedPreferences sharedPreferences5 = getSharedPreferences("weiguanzhuyouji", MODE_PRIVATE);
                            ...
                            Intent intent = new Intent(YoujiCircleActivity.this, YoujiDetailActivity.class);
                            intent.putExtras(bundle);
                    ...
                    break;
                case 2:
                    ToastUtil.show(YoujiCircleActivity.this, "获取数据失败！检查网络");
